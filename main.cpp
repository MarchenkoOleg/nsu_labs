...
TEST(TemplateHashTableTest, Constructor) {
    try {
        TemplateHashTable<Key, Val> a;
    }
    catch (...) {
        throw;
    }
...
TEST(TemplateHashTableTest, CopyConstructor) {
    try {
        TemplateHashTable<Key, Val> a;
        TemplateHashTable<Key, Val> b = a;
    }
    catch (...) {
        throw;
    }
...
TEST(TemplateHashTableTest, TestInsert) {
    TemplateHashTable<Key, Val> a;
    Val val;
    ASSERT_EQ(a.size(), 0);
    for (int i = 0; i < 10; ++i) {
...
TEST(TemplateHashTableTest, InsertRehashing) {
    TemplateHashTable<Key, Val> a;
    Val val;
    for (int i = 0; i < 100; ++i) {
        val.age = std::rand()%100;
...
TEST(TemplateHashTableTest, Contains) {
    TemplateHashTable<Key, Val> a;
    Val val;
    for (int i = 0; i < 500; ++i) {
        val.age = std::rand()%100;
...
TEST(TemplateHashTableTest, Erase) {
    TemplateHashTable<Key, Val> a;
    Val val;
...
TEST(TemplateHashTableTest, Clear) {
    TemplateHashTable<Key, Val> a;
    Val val;
    for (int i = 0; i < 500; ++i) {
        val.age = std::rand()%100;
...
TEST(TemplateHashTableTest, Size) {
    TemplateHashTable<Key, Val> a;
    Val val;
    for (int i = 0; i < 500; ++i) {
        val.age = std::rand()%100;
...
TEST(TemplateHashTableTest, Empty) {
    TemplateHashTable<Key, Val> a;
    Val val;
    EXPECT_TRUE(a.empty());
    for (int i = 0; i < 500; ++i) {
...
TEST(TemplateHashTableTest, OperatorEq) {
    TemplateHashTable<Key, Val> a;
    Val val1;
    TemplateHashTable<Key, Val> b;
    Val val2;
    for (int i = 0; i < 500; ++i) {
    ...
    EXPECT_FALSE(a == b);
    TemplateHashTable<Key, Val> c;
    TemplateHashTable<Key, Val> d;
    c.insert("Key1", val1);
    d.insert("Key2", val2);
    EXPECT_FALSE(c == d);
}

TEST(TemplateHashTableTest, OperatorNotEq) {
    TemplateHashTable<Key, Val> a;
    TemplateHashTable<Key, Val> b;
    Val val1;
    Val val2;
...
TEST(TemplateHashTableTest, Swap) {
    TemplateHashTable<Key, Val> a;
    TemplateHashTable<Key, Val> b;
    Val val1;
    Val val2;
    ...
    TemplateHashTable<Key, Val> buf1 = a;
    TemplateHashTable<Key, Val> buf2 = b;
    a.swap(b);
    EXPECT_TRUE(a == buf2);
    EXPECT_TRUE(b == buf1);
}

TEST(TemplateHashTableTest, At) {
    TemplateHashTable<Key, Val> a;
    Val val;
    val.age = std::rand()%100;
    val.weight = std::rand()%100;
    ...
    ASSERT_THROW(a.at("NotKey"), std::runtime_error);
    EXPECT_EQ(val.age, a.at("Key").age);
    EXPECT_EQ(val.weight, a.at("Key").weight);
}

TEST(TemplateHashTableTest, ConAt) {
    TemplateHashTable<Key, Val> a;
    Val val;
    val.age = std::rand()%100;
    val.weight = std::rand()%100;
    a.insert("Key", val);
    const TemplateHashTable<Key, Val> b = a;
    ASSERT_NO_THROW(b.at("Key"));
    ASSERT_THROW(b.at("NotKey"), std::runtime_error);
    EXPECT_EQ(val.age, b.at("Key").age);
    EXPECT_EQ(val.weight, b.at("Key").weight);
}

TEST(TemplateHashTableTest, SquBr) {
    TemplateHashTable<Key, Val> a;
    Val val;
    val.age = std::rand()%100;
    val.weight = std::rand()%100;
...
TEST(TemplateHashTableTest, Assignment) {
    TemplateHashTable<Key, Val> a;
    TemplateHashTable<Key, Val> b;
    Val val;
    val.age = std::rand()%100;
